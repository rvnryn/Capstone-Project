...
from app.supabase import get_db  # You must have a get_db dependency that yields a Session
...
async def put_inventory_log(
    ...
    try:
        ...
        for entry in entries:
            ...
            try:
                action_date_dt = datetime.datetime.fromisoformat(entry_data["action_date"].replace("Z", "+00:00"))
                ...
                raise HTTPException(status_code=400, detail=f"Invalid action_date: {entry_data['action_date']}")
            # Ensure int types
