...
export default function AddMenuPage() {
  ...
  const [ingredientToRemoveIdx, setIngredientToRemoveIdx] = useState<number | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isOnline) {
      setError("You are offline. Please connect to the internet to add a menu item.");
