...
export function useInventoryAPI() {
  ...
  const deleteTodayItem = useCallback(async (id: string | number) => {
    const response = await axiosInstance.delete(`/api/inventory-today/${id}`);
    return response.data;
  }, []);
  ...
  const deleteSurplusItem = useCallback(async (id: string | number) => {
    const response = await axiosInstance.delete(`/api/inventory-surplus/${id}`);
    return response.data;
  }, []);
    ...
    async (id: string | number, quantity: number) => {
      try {
        const response = await axiosInstance.post(
          `/api/inventory/${id}/transfer-to-today`,
          { quantity }
        );
        return response.data;
      } catch (error: any) {
        console.error(
          "transferToToday API error:",
          error.response?.data || error.message
        );
        throw error;
      }
  ...
  const transferToSurplus = useCallback(
    async (id: string | number, quantity: number) => {
      try {
        const response = await axiosInstance.post(
          `/api/inventory-today/${id}/transfer-to-surplus`,
          { quantity }
        );
        return response.data;
      } catch (error: any) {
        console.error(
          "transferToSurplus API error:",
          error.response?.data || error.message
        );
        throw error;
      }
  ...
  const transferSurplusToToday = useCallback(
    async (id: string | number, quantity: number) => {
      try {
        const response = await axiosInstance.post(
          `/api/inventory-surplus/${id}/transfer-to-today`,
          { quantity }
        );
        return response.data;
      } catch (error: any) {
