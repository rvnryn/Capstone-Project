  ...
  const inventoryButtons = [
    {
      ...
      description: "Complete overview of all inventory items and stock levels",
    ...
    },
    {
      ...
      description: "Daily operational inventory for immediate use",
      color: "from-black to-gray-900",
      hoverColor: "hover:from-gray-900 hover:to-gray-800",
      badge: "Active",
    },
    {
      ...
      description: "Excess items and overflow storage management",
      color: "from-black to-gray-900",
      hoverColor: "hover:from-gray-900 hover:to-gray-800",
      badge: "Storage",
    },
    ...
    <section>
      ...
      <ResponsiveMain>
        <main
          ...
          aria-label="Master Inventory main content"
          tabIndex={-1}
        >
            ...
            <section className="bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-sm rounded-lg xs:rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-2xl border border-gray-800/50 p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 2xl:p-12 w-full">
              <div className="text-center mb-4 xs:mb-5 sm:mb-6 md:mb-8 lg:mb-10 xl:mb-12">
                <div className="flex flex-col items-center justify-center gap-1 xs:gap-2 sm:gap-3 mb-2 xs:mb-3 sm:mb-4">
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-yellow-400 to-yellow-500 p-1.5 xs:p-2 sm:p-3 md:p-4 lg:p-5 rounded-full shadow-lg shadow-yellow-400/50">
                      <MdInventory2 className="text-black text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl" />
                    </div>
                  </div>
                  <div className="flex items-center justify-center gap-1 xs:gap-2 sm:gap-3">
                    <h1 className="text-base xs:text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-500 bg-clip-text text-transparent font-poppins text-center">
                ...
                <p className="text-gray-400 text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl max-w-xs xs:max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mx-auto leading-relaxed px-1 xs:px-2 sm:px-3 md:px-0 font-medium">
                  Efficiently manage your restaurant's inventory across all
                  storage locations with real-time tracking and analytics
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-2 xs:gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-8">
                {inventoryButtons.map((button, index) => (
                  ...
                  transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-500/30 border border-yellow-400/20
                  ...
                  >
                    ...
                    <div className="relative flex flex-col sm:flex-row lg:flex-col xl:flex-row items-start sm:items-center lg:items-start xl:items-center p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 gap-2 xs:gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                      ...
                      <div className="flex-shrink-0 order-1">
                        <div
                          className="p-1.5 xs:p-2 sm:p-3 md:p-4 lg:p-3 xl:p-4 bg-yellow-400/15 backdrop-blur-sm rounded-md xs:rounded-lg sm:rounded-xl border border-yellow-400/30 
                      group-hover:bg-yellow-400/25 transition-all duration-300 group-hover:scale-105 sm:group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-yellow-400/20"
                        >
                      ...
                      <div className="flex-1 min-w-0 order-3 sm:order-2 lg:order-3 xl:order-2">
                        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row sm:items-center lg:items-start xl:items-center gap-1 xs:gap-2 sm:gap-3 lg:gap-2 xl:gap-3 mb-1 xs:mb-2">
                          <h3 className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-lg xl:text-xl 2xl:text-2xl font-bold text-white font-poppins group-hover:text-yellow-200 transition-colors duration-300">
                            {button.title}
                          </h3>
                          <span className="px-1.5 xs:px-2 sm:px-3 py-0.5 xs:py-1 bg-yellow-400/20 backdrop-blur-sm rounded-full text-xs font-semibold text-yellow-300 border border-yellow-400/40 group-hover:bg-yellow-400/30 group-hover:text-yellow-200 transition-all duration-300 w-fit">
                            {button.badge}
                          </span>
                        </div>
                      ...
                      <div className="flex-shrink-0 order-2 sm:order-3 lg:order-2 xl:order-3 self-end sm:self-center lg:self-end xl:self-center">
                        <div
                          className="p-1 xs:p-1.5 sm:p-2 md:p-3 lg:p-2 xl:p-3 bg-yellow-400/15 backdrop-blur-sm rounded-full border border-yellow-400/30 
                      group-hover:bg-yellow-400/25 group-hover:translate-x-1 sm:group-hover:translate-x-2 group-hover:scale-105 sm:group-hover:scale-110 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-yellow-400/20"
                        >
                          <FaChevronRight className="text-yellow-400 text-xs xs:text-sm sm:text-base md:text-lg lg:text-base xl:text-lg group-hover:text-yellow-300 transition-colors duration-300" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div
                      className="absolute inset-0 bg-gradient-to-r from-yellow-400/0 to-yellow-500/0 
                  group-hover:from-yellow-400/5 group-hover:to-yellow-500/5 transition-all duration-300"
                    ></div>

                    {/* Subtle Animation Lines */}
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      <div className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-yellow-400/50 to-transparent transform -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                      <div className="absolute bottom-0 right-0 w-full h-0.5 bg-gradient-to-l from-transparent via-yellow-400/50 to-transparent transform translate-x-full group-hover:-translate-x-full transition-transform duration-1000 delay-200"></div>
                    </div>
                  </div>
                ))}
              </div>
