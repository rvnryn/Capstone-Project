export const routes = {
     ...
     UpdateInventory: (id: number | string) => `/Features/Inventory/Master_Inventory/Update_Inventory?id=${id}`,
     ViewInventory: (id: number | string) => `/Features/Inventory/Master_Inventory/View_Inventory?id=${id}`,
     UpdateTodayInventory: (id: number | string) => `/Features/Inventory/Today_Inventory/Update_Today_Inventory?id=${id}`,
     ViewTodayInventory: (id: number | string) => `/Features/Inventory/Today_Inventory/View_Today_Inventory?id=${id}`,
     ViewSurplusInventory: (id: number | string) => `/Features/Inventory/Surplus_Inventory/View_Surplus_Inventory?id=${id}`,
     ...
     UpdateSupplier: (id: number | string) => `/Features/Supplier/Update_Supplier?id=${id}`,
     ViewSupplier: (id: number | string) => `/Features/Supplier/View_Supplier?id=${id}`,
     settings: '/Features/Settings',
     user_management_settings: '/Features/Settings/userManagement',
     addUsers: '/Features/Settings/userManagement/Add_Users',
     UpdateUsers: (id: number | string) => `/Features/Settings/userManagement/Update_Users?id=${id}`,
     ViewUsers: (id: number | string) => `/Features/Settings/userManagement/View_Users?id=${id}`,
